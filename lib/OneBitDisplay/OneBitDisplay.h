...
// 5 possible font sizes: 8x8, 16x32, 6x8, 12x16 (stretched from 6x8 with smoothing), 16x16
// (stretched from 8x8)
enum {
    FONT_6x8 = 0,
    FONT_8x8,
...
// Copy the current bitmap buffer from its native form (LSB_FIRST, VERTICAL_BYTES) to the requested
// form A copy of the same format will just do a memcpy

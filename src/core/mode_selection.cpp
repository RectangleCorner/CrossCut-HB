    ...
    switch (mode_config.mode_id) {
        case MODE_MELEE:
            if (config.travelTime == true) {
                melee_nerfed.SetConfig(
                    mode_config,
                    config.melee_options,
                    config.meleeCWOS,
                    config.modx_x_wd,
                    config.modx_y_wd,
                    config.mody_x_wd,
        ...
        case MODE_FGC:
            ...
            break;
        case MODE_WINGMANFGC:
            wingman.SetConfig(mode_config);
            set_mode(backend, &wingman);
            break;

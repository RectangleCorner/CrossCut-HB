...
MeleeNerfs::MeleeNerfs() : ControllerMode() {}

void MeleeNerfs::SetConfig(
...
void MeleeNerfs::HandleSocd(InputState &inputs) {
    InputMode::HandleSocd(inputs);
}

void MeleeNerfs::UpdateDigitalOutputs(const InputState &inputs, OutputState &outputs) {
...
void MeleeNerfs::UpdateAnalogOutputs(const InputState &inputs, OutputState &outputs) {
    ...
    if (inputs.lt2) {
        ...
        if (directions.diagonal && !shield_button_pressed) {
            if (!inputs.rf1) {
                ...
                // 5375 8250 - 33.08deg - 43 66 - modY + B + cLeft
